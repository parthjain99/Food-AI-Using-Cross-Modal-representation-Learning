...
if __name__ == '__main__':
    ...
    # model_path = '../snapshots/vit_90epoch.pt'
    model_path = '/common/users/sf716/snapshots/e4_08_512/vit_130epoch.pt'
    print(model_path)
    ...
    eva(img_path=img_path, recipe_emb=rec_emb, partition=partition, data_path=data_path, batch_size=512,
